...
return [
    ...
    'drivers' => 'Șoferi',
    'assign_to_driver' => 'Atribuie șoferului',
    'choose_driver' => 'Alege șofer',
    ...
    'enable_disable_purchases_modules' => 'Adăugați Achiziții',
    'enable_disable_sale_modules' => 'Adăugați Vânzare',
    'enable_disable_products_modules' => 'Produse',
    'sub_modules' => 'Submodule',
    'select_status' => 'selectați statusul',
    'change_status' => 'schimbați statusul',
    'new_status' => 'status nou',
    'current_status' => 'status actual',
    'refresh' => 'reîmprospăta',
    'select_one_row' => 'vă rugăm selectați un rând',
    'Saturday' => "Sâmbătă",
    'Friday' => "Vineri",
    'Thursday' => "Joi",
    'Wednesday' => "Miercuri",
    ...
    'Monday' => "Luni",
    'Sunday' => "Duminică",
    'work_time' => "timp de lucru",
    'start_shift' => "începere tură",
    'end_shift' => "sfârșit de tură",
    'close' => "închide",
    'save' => "salvează",
    'remove' => "îndepărtează",
    "shift" => "timp de lucru",
    "no_shifts_added" => "te rog să adaugi mai întâi o tură",
    "the_end_time" => "ora de sfârșit trebuie să fie după ora de început",
    "you_are_not_allowed" => "Nu ai voie să folosești sistemul în acest moment.",
    "you_are_not_within" => "Nu te afli în timpul tău permis.",
    "manage_shifts" => "Gestionați turele",
    'enable_service_staff_report' => "raport personal de serviciu",
    'enable_table_report' => "raport tabel",
    'enable_sales_representative_report' => "raport reprezentant de vânzări",
    'enable_register_report' => "raport de înregistrare",
    'enable_expense_report' => "raport de cheltuieli",
    'enable_sell_payment_report' => "raport plată vânzare",
    'enable_purchase_payment_report' => "raport plată achiziție",
    'enable_product_sell_report' => "raport vânzare produs",
    'enable_product_purchase_report' => "raport achiziție produs",
    'enable_items_report' => "raport articole",
    'enable_stock_adjustment_report' => "raport ajustare stoc",
    'enable_stock_report' => "raport stoc",
    'enable_customer_group_report' => "raport grup de clienți",
    'enable_customer_supplier_report' => "raport client furnizor",
    'enable_taxes_report' => "raport taxe",
    'enable_purchase_sell_report' => "raport achiziție vânzare",
    'enable_add_expense' => "adaugă cheltuială",
    'enable_profit_loss_report' => "raport profit și pierdere",
    'enable_stock_adjustment' => "ajustare stoc",
    'enable_add_stock_transfer' => "adaugă transfer de stoc",
    'enable_sale_point' => "punct de vânzare",
    'enable_add_sale' => "adaugă vânzare",
    'enable_add_product' => "adaugă produs",
    'enable_add_purchase' => "adaugă achiziție",
    'enable_add_user' => "adaugă utilizator",
    'statistics' => "statistici",
    'most_selling_users' => "clienți cei mai vânduți",
    'most_expense_categories' => "cele mai multe categorii de cheltuieli",
    'most_selling_products' => "cele mai vândute produse",
    'most_clients' => "cei mai îndatorați clienți",
    'enable_disable_quick_access_list' => "activare/dezactivare listă de acces rapid",
    'quick_access_list' => "listă de acces rapid",
    'cannot_enable_more_than_12' => "nu se pot activa mai mult de 12",
    'most_selling' => 'Utilizatori cu cele mai multe vânzări',
    'show_chart' => 'Diagramă',
    'show_table' => 'Tabel',
];
