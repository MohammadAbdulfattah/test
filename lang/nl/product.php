<?php
 ...
 return [
    ...
    'enable_sku_symbol' => 'SKU-symbool inschakelen',
    'enable_categories' => 'Categorieën inschakelen',
    'enable_brand' => 'Merk inschakelen',
    'enable_barcode_type' => 'Barcode-type inschakelen',
    'enable_type' => 'Type inschakelen',
    'enable_customized_fields' => 'Aangepaste velden inschakelen',
    'enable_weight' => 'Gewicht inschakelen',
    'enable_not_for_sale_button' => 'Niet te koop-knop inschakelen',
    'enable_serial_number' => 'Serienummer inschakelen',
    'enable_product_brochure' => 'Productbrochure inschakelen',
    'enable_product_image' => 'Productafbeelding inschakelen',
    'enable_description' => 'Beschrijving inschakelen',
    'enable_stock_management' => 'Voorraadbeheer inschakelen',
    'enable_product_location' => 'Productlocatie inschakelen',
 ];
