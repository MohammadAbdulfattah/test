...
return [
    ...
    'enable_disable_purchases_modules' => 'Add Purchases',
    'enable_disable_sale_modules' => 'Add Sale',
    'enable_disable_products_modules' => 'Products',
    'enable_disable_expenses_modules' => 'Add expense',
    'enable_disable_contacts_modules' => 'Add contact',
    'enable_disable_user_modules' => 'Add user',
    ...
    'refresh' => 'refresh',
    'select_one_row' => 'please select row',
    'Saturday' => "Saturday",
    'Friday' => "Friday",
    'Thursday' => "Thursday",
    'Wednesday' => "Wednesday",
    ...
    'remove' => "remove",
    "shift"=>'work time',
    "no_shifts_added"=> 'please add shift first',
    "the_end_time" => 'the end time must be after the start time',
    "you_are_not_allowed" => 'You are not allowed to use the system at this time.',
    "you_are_not_within" => 'You are not within your allowed shift time.',
    "manage_shifts" => 'Manage shifts',
    'access_denied' => "Access denied",
    'if_now' => "if you back to work click on Go Back button",
    'enable_service_staff_report' => "service staff report",
    'enable_table_report' => "table report",
    'enable_sales_representative_report' => "sales representative report",
    'enable_register_report' => "register report",
    'enable_expense_report' => "expense report",
    'enable_sell_payment_report' => "sell payment report",
    'enable_purchase_payment_report' => "purchase payment report",
    'enable_product_sell_report' => "product sell report",
    'enable_product_purchase_report' => "product purchase report",
    'enable_items_report' => "items report",
    'enable_stock_adjustment_report' => "stock adjustment report",
    'enable_stock_report' => "stock report",
    'enable_customer_group_report' => "customer group report",
    'enable_customer_supplier_report' => "customer supplier report",
    'enable_taxes_report' => "taxes report",
    'enable_purchase_sell_report' => "purchase sell report",
    'enable_add_expense' => "add expense",
    'enable_profit_loss_report' => "profit loss report",
    'enable_stock_adjustment' => "stock adjustment",
    'enable_add_stock_transfer' => "add stock transfer",
    'enable_sale_point' => "sale point",
    'enable_add_sale' => "add sale",
    'enable_add_product' => "add product",
    'enable_add_purchase' => "add purchase",
    'enable_add_user' => "add user",
    'statistics' => "statistics",
    'most_selling_users' => "most selling clients",
    'most_expense_categories' => "most expense categories",
    'most_selling_products' => "most selling products",
    'most_clients' => "most indebted clients",
    'enable_disable_quick_access_list' => "enable disable quick access list",
    'quick_access_list' => "quick access list",
    'cannot_enable_more_than_12' => "cannot enable more than 12",
    'most_selling' => "most selling users",
    'show_chart' => "chart",
    'show_table' => "table",
    'Driver' => 'Driver',
