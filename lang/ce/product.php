<?php
 ...
 return [
    ...
    'enable_sku_symbol' => '启用SKU符号',
    'enable_categories' => '启用分类',
    'enable_brand' => '启用品牌',
    'enable_barcode_type' => '启用条形码类型',
    'enable_type' => '启用类型',
    'enable_customized_fields' => '启用自定义字段',
    'enable_weight' => '启用重量',
    'enable_not_for_sale_button' => '启用非销售按钮',
    'enable_serial_number' => '启用序列号',
    'enable_product_brochure' => '启用产品手册',
    'enable_product_image' => '启用产品图片',
    'enable_description' => '启用描述',
    'enable_stock_management' => '启用库存管理',
    'enable_product_location' => '启用产品位置',
 ];
