...
return [
    ...
    'drivers' => 'Fahrer',
    'assign_to_driver' => 'Fahrer zuweisen',
    'choose_driver' => 'Fahrer auswählen',
    ...
    'enable_disable_purchases_modules' => 'Einkäufe Hinzufügen',
    'enable_disable_sale_modules' => 'Verkauf Hinzufügen',
    ...
    'refresh' => 'actualizar',
    'select_one_row' => 'por favor seleccione una fila',
    'Saturday' => "Samstag",
    'Friday' => "Freitag",
    'Thursday' => "Donnerstag",
    'Wednesday' => "Mittwoch",
    ...
    'start_shift' => "Schichtbeginn",
    'end_shift' => "Schichtende",
    'close' => "schließen",
    'save' => "speichern",
    'remove' => "entfernen",
    "shift" => "Arbeitszeit",
    "no_shifts_added" => "Bitte fügen Sie zuerst eine Schicht hinzu.",
    "the_end_time" => "Die Endzeit muss nach der Startzeit liegen.",
    "you_are_not_allowed" => "Sie dürfen das System zu diesem Zeitpunkt nicht verwenden.",
    "you_are_not_within" => "Sie befinden sich nicht innerhalb Ihrer erlaubten Schichtzeit.",
    "manage_shifts" => "Schichten verwalten",
    'enable_service_staff_report' => "Servicepersonalbericht",
    'enable_table_report' => "Tischbericht",
    'enable_sales_representative_report' => "Verkaufsvertreterbericht",
    'enable_register_report' => "Registrierungsbericht",
    'enable_expense_report' => "Ausgabenbericht",
    'enable_sell_payment_report' => "Verkaufszahlungsbericht",
    'enable_purchase_payment_report' => "Einkaufszahlungsbericht",
    'enable_product_sell_report' => "Produktverkaufsbericht",
    'enable_product_purchase_report' => "Produkteinkaufsbericht",
    'enable_items_report' => "Artikelbericht",
    'enable_stock_adjustment_report' => "Bestandsanpassungsbericht",
    'enable_stock_report' => "Bestandsbericht",
    'enable_customer_group_report' => "Kundengruppenbericht",
    'enable_customer_supplier_report' => "Kunden-Lieferanten-Bericht",
    'enable_taxes_report' => "Steuerbericht",
    'enable_purchase_sell_report' => "Einkaufsverkaufsbericht",
    'enable_add_expense' => "Ausgabe hinzufügen",
    'enable_profit_loss_report' => "Gewinn- und Verlustbericht",
    'enable_stock_adjustment' => "Bestandsanpassung",
    'enable_add_stock_transfer' => "Bestandsübertragung hinzufügen",
    'enable_sale_point' => "Verkaufspunkt",
    'enable_add_sale' => "Verkauf hinzufügen",
    'enable_add_product' => "Produkt hinzufügen",
    'enable_add_purchase' => "Einkauf hinzufügen",
    'enable_add_user' => "Benutzer hinzufügen",
    'statistics' => "Statistiken",
    'most_selling_users' => "Die meistverkauften Kunden",
    'most_expense_categories' => "Die meisten Ausgabenkategorien",
    'most_selling_products' => "Die meistverkauften Produkte",
    'most_clients' => "Die meisten verschuldeten Kunden",
    'enable_disable_quick_access_list' => "Schnellzugriffs Liste aktivieren/deaktivieren",
    'quick_access_list' => "Schnellzugriffs Liste",
    'cannot_enable_more_than_12' => "Es können nicht mehr als 12 aktiviert werden",
    'most_selling' => 'Meistverkaufte Benutzer',
    'show_chart' => 'Diagramm',
    'show_table' => 'Tabelle',
];
