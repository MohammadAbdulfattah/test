...
use App\Http\Controllers\CustomerSectorController;
...
Route::get('/shift-denied', function () {
    return view('shift.shift_denied');
})->middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone',  'AdminNavBarMenu', 'CheckUserLogin'])->name('shift.denied');
//Routes for authenticated users only

Route::middleware(['setData', 'check_sales_user','custom_token_auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    Route::get('/pos/create', [SellPosController::class, 'create'])->name('pos.create.custom');
    Route::get('/sells/pos/get-product-suggestion', [SellPosController::class, 'getProductSuggestion']);
    Route::resource('pos', SellPosController::class)->except(['create']);
});
//Routes for authenticated users only
Route::middleware(['setData', 'auth','check_sales_user','custom_token_auth', 'SetSessionData', 'language', 'timezone',  'AdminNavBarMenu', 'CheckUserLogin', 'check.shift'])->group(function () {
    ...
    Route::get('/home2', [HomeController::class, 'statistics'])->name('statistics');
    Route::get('/home/get-totals', [HomeController::class, 'getTotals']);
    Route::get('/home/get-expenses', [HomeController::class, 'getExpenses']);
    Route::get('/home/most-selling-customers', [HomeController::class, 'getMostSellingCustomer']);
    Route::get('/home/most-selling-users', [HomeController::class, 'getMostSellingUsers']);
    Route::get('/home/most-indebted-customers', [HomeController::class, 'getMostIndebtedCustomer']);
    Route::get('/home/most-selling-products', [HomeController::class, 'getMostSellingProducts']);
    ...
    Route::get('/contacts/get-payment-modal/{contact_id}', [TransactionPaymentController::class, 'getPayContactDue']);
    ...
    Route::get('/contacts/check/limit/pay/{id}', [ContactController::class, 'check_customer_limit_pay']);
    ...
    Route::post('/sells/update/shipping', [SellController::class, 'updateShippingStatus']);
    //Route::post('/sells/multi_print/', [SellPosController::class, 'downloadMultiplePdf']);
    ...
    Route::get('/sells/driver', [SellController::class, 'getDrivers']);
    Route::post('/sells/driver', [SellController::class, 'assignToDrivers']);
    Route::post('shifts', [ManageUserController::class, 'saveShifts']);
    ...
    Route::get('/reports/user-contacts-due-report', [ReportController::class, 'getUsersContactsDueReport']);
    Route::get('/reports/active-users', [ReportController::class, 'getActiveUsers']);
    ...
    Route::get('/reports/total-payments-transaction', [ReportController::class, 'getTotalPaymentsTransaction']);
    Route::get('/reports/total-due', [ReportController::class, 'getTotalDue']);
    ...
    Route::get('/add_stock_adjustment_line/{id}', [StockAdjustmentController::class, 'add_stock_adjustment_line'])->name('stock-adjustments.add-line');
    Route::get('/stock-adjustments', [StockAdjustmentController::class, 'index'])->name('stock_adjustment.index');
    ...
    Route::resource('customer-sectors', CustomerSectorController::class);
    Route::get('/sectors/children/{parent_id}', [\App\Http\Controllers\CustomerSectorController::class, 'getChildren']);
    ...
    Route::get('smart_root_discounts', [DiscountController::class, 'smart_root_discounts'])->name('smart_root_discounts');
    Route::get('create_smart_root_discount', [DiscountController::class, 'create_smart_root_discount'])->name('create_smart_root_discount');
    Route::post('store_smart_discount', [DiscountController::class, 'store_smart_discount'])->name('store_smart_discount');

    Route::get('/edit_smart_root_discounts/{id}', [DiscountController::class, 'editSmartRootDiscount'])->name('editSmartRootDiscount');
    Route::put('/update_smart_discount/{id}', [DiscountController::class, 'update_smart_discount'])->name('update_smart_discount');
    Route::get('/showSmartRootDiscount/{id}', [DiscountController::class, 'showSmartRootDiscount'])->name('showSmartRootDiscount');
    Route::get('/delete_smart_root_discounts/{id}', [DiscountController::class, 'deleteSmartRootDiscount'])->name('deleteSmartRootDiscount');
 
    Route::post('/check-smart-root-discount', [DiscountController::class, 'check_smart_root_discount']);
    Route::post('/check-smart-root-discount2', [DiscountController::class, 'check_smart_root_discount2']);
    Route::post('/check-smart-root-discount3', [DiscountController::class, 'check_smart_root_discount3']);
    Route::get('/get_sub_units_by_product/{id}', [DiscountController::class, 'get_sub_units_by_products']);
    Route::get('/get_pecies_by_products/{id}', [DiscountController::class, 'get_pecies_by_products']);


    Route::post('/active-smart-root-discount/{id}', [DiscountController::class, 'active_smart_discount'])->name('active_smart_discount');
    Route::post('/messActive-smart-root-discount/{id}', [DiscountController::class, 'messActive_smart_discount'])->name('messActive_smart_discount');


    Route::get('/saveComplete', [DiscountController::class, 'saveComplete'])->name('saveComplete');

    
    Route::get('/getSmartRootDiscountByUser/{id}', [DiscountController::class, 'getSmartRootDiscountByUser']);
    Route::get('/selectContactToPay', [SellPosController::class, 'selectContactToPay']);
    Route::post('/add-sub-conditions', [DiscountController::class, 'add_sub_conditions']);
    Route::post('/add-sub-results', [DiscountController::class, 'add_sub_results']);
    Route::post('/add-final-discount', [DiscountController::class, 'add_final_discount']);
    Route::post('/add-third-final-discount', [DiscountController::class, 'add_final_discount3']);
...
Route::middleware(['setData', 'auth','check_sales_user', 'SetSessionData', 'language', 'timezone', 'check.shift'])->group(function () {
    ...
    Route::post('/sells/multi_print', [SellPosController::class, 'printMultiInvoice']);
