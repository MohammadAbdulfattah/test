...
@section('content')
    ...
    <section class="content no-print">
        {!! Form::open([
            'url' => action([Modules\CashVan\Http\Controllers\VanStockController::class, 'storeVanOrder'], [$id]),
            'method' => 'post',
        ...
        @component('components.widget', ['class' => 'box-solid'])
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('__location_id_disabled', __('lang_v1.location_from') . ':*') !!}
                        {!! Form::select('__location_id_disabled', $business_locations, $location_id, [
            ...
            <div class="row">
                ...
                <div class="col-sm-12 text-center">
                    <button type="submit" id="save_stock_transfer"
                        class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-lg tw-text-white">@lang('lang_v1.new_order')</button>
