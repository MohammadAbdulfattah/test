<div class="modal-header">
    ...
    @if (!$sell_transfer->delete_stock)
        <h4 class="modal-title" id="modalTitle"> @lang('cashvan::stock.the_deleted_stock') (<b>@lang('purchase.ref_no'):</b>
            #{{ $sell_transfer->ref_no }})
        @else
            <h4 class="modal-title" id="modalTitle"> @lang('cashvan::stock.the_added_stock') (<b>@lang('purchase.ref_no'):</b>
                #{{ $sell_transfer->ref_no }})
    @endif
    ...
    <div class="row">
        ...
        <div class="row print_section">
            @if (!$sell_transfer->type == 'sell')
                <div class="col-xs-12">
                    <img class="center-block" src="data:image/png;base64,{{ DNS1D::getBarcodePNG($sell_transfer->ref_no, 'C128', 2, 30, [39, 48, 54], true) }}">
                  </div>
            @endif
        </div>
</div>
