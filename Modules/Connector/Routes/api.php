...
use Modules\Connector\Http\Controllers\Api\Auth\AuthController;
...
Route::middleware('auth:api', 'timezone')->prefix('connector/api')->group(function () {
    ...
    Route::post('sell-payment', [Modules\Connector\Http\Controllers\Api\SellController::class, 'addSellPayment']);

   
    Route::get('list-sell-return', [Modules\Connector\Http\Controllers\Api\SellController::class, 'listSellReturn']);
    
    Route::get('sell/search/{invoice_no}', [Modules\Connector\Http\Controllers\Api\SellController::class, 'searchByInvoiceNo']);
