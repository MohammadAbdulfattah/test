...
@section('content')
    <div id="group-form">
        <section class="content-header">
            <h2 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">Create Group</h2>
        </section>

        {{ Form::open(['url' => route("group.store"), 'method' => 'POST', 'id' => 'groupForm']) }}
        <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('supervisor_id', $users ?? [], null, [
