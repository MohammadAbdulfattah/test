...
$(document).ready(function () {
    ...
    exportButtons=[
        {
            ...
            className: 'tw-dropdown-item bg-white',
            exportOptions: {
                columns: ':visible',
            },
            footer: true,
    ...
    var buttons = [
        {
                    text: '<i class="fa fa-refresh" aria-hidden="true"></i> ' +LANG.reloading,
                    ...
                    extend: 'collection',
                    text: '<i class="fa fa-download" aria-hidden="true"></i> ' + LANG.export,
                    className: 'tw-dw-btn tw-dw-btn-outline tw-my-2 tw-rounded-none',
    ...
    jQuery.extend($.fn.dataTable.defaults, {
        ...
        //stateSave: true,
        fixedHeader: true,
        dom: '<"row "<"col-sm-4"f><"col-sm-8"B><"col-sm-1"l>>tip',
        buttons: buttons,
        colReorder: true,
        aLengthMenu: [
...
ranges[LANG.max_date] = [
    moment('2010-01-01'),
    moment().endOf('year') // This gets 31st December of the current year
];
ranges[LANG.this_year + ' - ' + LANG.last_year] = [
    moment().subtract(1, 'year').startOf('year'), // 1st Jan of last year
    moment().endOf('year')                        // 31st Dec of this year
];
