...
class Transaction extends Model
{
    ...
    protected $casts = [
        ...
        'status_of_smart_root_discount_id' => 'array',
    ];
    ...
    public function statusOfSmartRootDiscounts()
    {
        return $this->belongsToMany(StatusOfSmartRootDiscount::class, 'status_of_smart_root_discount_id');
    }
