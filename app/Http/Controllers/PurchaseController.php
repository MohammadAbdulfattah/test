...
class PurchaseController extends Controller
{
            ...
            return Datatables::of($purchases)
                ->addColumn('action', function ($row) {
                    ...
                    if ($row->status == 'ordered') {
                        ...
                        $html .= '<li><a href="#" data-href="'.action([\App\Http\Controllers\NotificationController::class, 'getTemplate'], ['transaction_id' => $row->id, 'template_for' => 'items_pending']).'" class="btn-modal" data-container="."><i class="fas fa-envelope" aria-hidden="true"></i> '.__('lang_v1.item_pending_notification').'</a></li>';
                    }
    ...
    public function create()
    {
        ...
        return view('purchase.create')
            ->with(compact('parent_sectors','taxes', 'orderStatuses', 'business_locations', 'currency_details', 'default_purchase_status', 'customer_groups', 'types', 'shortcuts', 'payment_line', 'payment_types', 'accounts', 'bl_attributes', 'common_settings'));
    }
