...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'AdminNavBarMenu' => \App\Http\Middleware\AdminNavBarMenu::class,
        'superadmin' => \App\Http\Middleware\Superadmin::class,
        'CheckUserLogin' => \App\Http\Middleware\CheckUserLogin::class,

        'check.shift' => \App\Http\Middleware\CheckUserShift::class,

        'custom_token_auth' => \App\Http\Middleware\CustomTokenAuth::class,
        'check_sales_user' => \App\Http\Middleware\CheckSalesUser::class,
