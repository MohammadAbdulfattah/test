...
{
    return $this->belongsToMany(Tag::class, 'gbs_contact_tags');
}
public function locations()
{
    return $this->belongsToMany(\App\BusinessLocation::class, 'contact_location', 'contact_id', 'location_id');
}


public function sector()
{
    return $this->belongsTo(\App\CustomerSector::class, 'sector_id');
}
