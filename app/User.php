...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany(\Modules\Gbs\Entities\Route::class, 'user_id');
    }
     ...
     * @return array users
     */
    public static function forDropdown($business_id, $prepend_none = true, $include_commission_agents = false, $prepend_all = false, $check_location_permission = false,$role_driver=false)
    {
