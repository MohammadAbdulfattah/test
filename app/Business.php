...
class Business extends Model
{
    ...
    protected $casts = [
        ...
        'enabled_products_modules' => 'array',
        'enabled_quick_list' => 'array',
        'enabled_sale_modules' => 'array',
        'enabled_purchases_modules' => 'array',
        'enabled_user_modules' => 'array',
        'enabled_contacts_modules' => 'array',
        'enabled_expenses_modules' => 'array',
