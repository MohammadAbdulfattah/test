        ...
        <div class="col-md-4">
            ...
            <div class="btn-group" data-toggle="buttons">
                ...
                <label class="btn btn-default">
                    <input type="radio" name="ledger_format" value="format_1"> @lang('lang_v1.format_1')
                </label>
                @else
                ...
                @if(session('business.enable_automatic_correction'))
                <label class="btn btn-default active">
                    <input type="radio" name="ledger_format" value="format_4" checked> @lang('lang_v1.format_4')
                </label>
                @endif
            </div>
            </div>
