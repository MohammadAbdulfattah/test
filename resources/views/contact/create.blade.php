<div class="modal-dialog modal-lg" role="document">
  ...
  @php
    ...
    $enabled_contacts_modules = (array)(!empty(session('business.enabled_contacts_modules')) ? session('business.enabled_contacts_modules') : []);
  ...
  @endphp
    ...
    <div class="modal-body">
        <div class="row">            
            <div class="col-md-4 contact_type_div @if(!in_array('enable_contact_type', $enabled_contacts_modules)) hide @endif">
            ...
            <div class="col-md-4 @if(!in_array('enable_contact_id', $enabled_contacts_modules)) hide @endif">
                <div class="form-group">
            ...
            <div class="col-md-4 customer_fields">
                <div class="form-group">
                    {!! Form::label('coordinates', __('lang_v1.coordinate') . ':') !!}
                  <div class="input-group">
                      <span class="input-group-addon">
                      ...
                      <div class="form-group">
                        ...
                        {!! Form::text('coordinates', null, ['class' => 'form-control input_number', 'placeholder' => '']) !!}
                    </div>
            ...
            <div class="col-md-4 customer_fields">
                <div class="form-group">
                    {!! Form::label('tags', __('lang_v1.tags') . ':') !!}
               
                      <div class="form-group">
              
                        {!! Form::select('tags_id[]', $tags ?? [], null , ['class' => 'form-control select2', 'multiple', 'style' => 'width: 100%;']); !!}
            ...
            <div class="col-md-4 customer_fields">
                <div class="form-group">
                    {!! Form::label('parent_sector', __('lang_v1.customer_sector') . ':') !!}
                    {!! Form::select('parent_sector', $parent_sectors, null, ['class' => 'form-control', 'id' => 'parent_sector']) !!}
                </div>
            ...
            <div class="col-md-4 customer_fields">
                <div class="form-group">
                    {!! Form::label('locations', __('lang_v1.location') . ':') !!}
            ...
            <div class="col-md-3 @if(!in_array('enable_second_mobile_number', $enabled_contacts_modules)) hide @endif">
                <div class="form-group">
            ...
            <div class="col-md-3 @if(!in_array('enable_phone', $enabled_contacts_modules)) hide @endif">
                <div class="form-group">
            ...
            <div class="col-md-3 @if(!in_array('enable_email', $enabled_contacts_modules)) hide @endif">
                <div class="form-group">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('limit_days', __('contact.limit_days') . ':*') !!}
                    <div class="input-group">
                        <span class="input-group-addon">
                       
                        </span>
                        {!! Form::number('limit_days', null, ['class' => 'form-control', 'placeholder' => __('contact.limit_days')]); !!}
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    {!! Form::label('reason', __('contact.reason') . ':*') !!}
                    <div class="input-group">
                        <span class="input-group-addon">
            ...
            @if(config('constants.enable_contact_assign') && $type !== 'lead')
                <div class="col-md-6 @if(!in_array('enable_custom_for', $enabled_contacts_modules)) hide @endif">
                      <div class="form-group">
        ...
        <div class="row">
            ...
            <div id="more_div" class="hide">
                {!! Form::hidden('position', null, ['id' => 'position']); !!}
                 @if(in_array('enable_tax_number', $enabled_contacts_modules)||in_array('enable_payment_period', $enabled_contacts_modules)||in_array('enable_opening_balance', $enabled_contacts_modules)||in_array('enable_credit_limit', $enabled_contacts_modules)) 
                    <div class="col-md-12"><hr/></div>
                @endif

                <div class="col-md-4 @if(!in_array('enable_tax_number', $enabled_contacts_modules)) hide @endif">
                    <div class="form-group">
                ...
                <div class="col-md-4 opening_balance @if(!in_array('enable_opening_balance', $enabled_contacts_modules)) hide @endif">
                  <div class="form-group">
                ...
                <div class="col-md-4 pay_term @if(!in_array('enable_payment_period', $enabled_contacts_modules)) hide @endif">
                  <div class="form-group">
                ...
                @endphp
                <div class="col-md-4 customer_fields @if(!in_array('enable_credit_limit', $enabled_contacts_modules)) hide @endif">
                  <div class="form-group">
                 ...
                 @if(in_array('enable_address', $enabled_contacts_modules)) 
                     <div class="col-md-12"><hr/></div>
                <div class="clearfix"></div>
          ...
          <div class="clearfix"></div>
           @if(in_array('enable_customized_fields', $enabled_contacts_modules)) 
                <div class="col-md-12">
            <hr/>
          </div>
          @php
          ...
          <div class="col-md-8 col-md-offset-2 shipping_addr_div mb-10 @if(!in_array('enable_shipping_address', $enabled_contacts_modules)) hide @endif" >
