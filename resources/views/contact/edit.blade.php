        ...
        <div class="col-md-4 customer_fields">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('tags_id[]', $tags ?? [], $selected_tags ?? [], ['class' => 'form-control select2', 'multiple', 'style' => 'width: 100%;']); !!}
...
{!! Form::label('parent_sector', __('lang_v1.customer_sector') . ':') !!}
    {!! Form::select('parent_sector', $parent_sectors, $parent_sector_id, ['class' => 'form-control', 'id' => 'parent_sector']) !!}

</div>


<div class="form-group" id="child_sector_div" style="{{ old('sector_id', $contact->sector_id ?? false) ? '' : 'display: none;' }}">
    {!! Form::label('sector_id', __('lang_v1.customer_sub_sector') . ':') !!}
    {!! Form::select('sector_id', $child_sectors ?? [], old('sector_id', $contact->sector_id ?? null), ['class' => 'form-control', 'id' => 'sector_id']) !!}
</div>
        ...
        <div class="col-md-4 customer_fields">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('coordinates',   $contact->coordinates, ['class' => 'form-control input_number', 'placeholder' => '']) !!}
                </div>
            </div>
          </div>
          <div class="col-md-4 customer_fields">
            <div class="form-group">
                ...
                {!! Form::select('location_id[]', $locations, $selected_location_ids ?? [], ['class' => 'form-control select2', 'multiple' => true]) !!}
