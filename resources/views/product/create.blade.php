...
<section class="content">
    ...
    $enabled_products_modules = (array)(!empty(session('business.enabled_products_modules')) ? session('business.enabled_products_modules') : []);
    @endphp
    ...
    <div class="row">
        ...
        <div class="col-sm-4 @if(!in_array('enable_sku_symbol', $enabled_products_modules)) hide @endif">
            <div class="form-group">
        ...
        <div class="col-sm-4 @if(!in_array('enable_barcode_type', $enabled_products_modules)) hide @endif">
            <div class="form-group">
        ...
        <div class="col-sm-4 @if(!in_array('enable_brand', $enabled_products_modules)) hide @endif">
            <div class="form-group">
        ...
        <div class="col-sm-4 @if(!in_array('enable_categories', $enabled_products_modules)) hide @endif">
            <div class="form-group">
        ...
        @endphp
        <div class="col-sm-4 @if(!in_array('enable_product_location', $enabled_products_modules)) hide @endif" >
            <div class="form-group">
        ...
        <div class="clearfix"></div>
        @if(in_array('enable_stock_management', $enabled_products_modules)) 
            <div class="col-sm-4">
                <div class="form-group">
                    <br>
                    <label>
        ...
        @endif
        <div class="clearfix"></div>
        <div class="col-sm-8 @if(!in_array('enable_description', $enabled_products_modules)) hide @endif">
            <div class="form-group">
        ...
        <div class="col-sm-4 @if(!in_array('enable_product_image', $enabled_products_modules)) hide @endif">
            <div class="form-group">
    ...
    <div class="col-sm-4 @if(!in_array('enable_product_brochure', $enabled_products_modules)) hide @endif">
        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 @if(!in_array('enable_serial_number', $enabled_products_modules)) hide @endif">
            <div class="form-group">
                <br>
                <label>
        ...
        <div class="col-sm-4 @if(!in_array('enable_not_for_sale_button', $enabled_products_modules)) hide @endif">
            <div class="form-group">
                <br>
                <label>
        ...
        <div class="col-sm-4 @if(!in_array('enable_weight', $enabled_products_modules)) hide @endif">
            <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 @if(!in_array('enable_type', $enabled_products_modules)) hide @endif ">
            <div class="form-group">
