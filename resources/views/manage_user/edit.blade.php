...
<section class="content">
            ...
            <div class="col-md-2">
              <div class="form-group">
                  <div class="checkbox">
                      <br>
                      <label>
                          {!! Form::checkbox('is_sales_user', 1, !empty($user->is_sales_user), ['class' => 'input-icheck']) !!}
    ...
    <div class="col-md-12">
        @component('components.widget', ['title' => __('lang_v1.roles_of_show_products')])
          ...
          <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('category', __( 'category.categories' ) . ':*') !!} 
            @show_tooltip(__('lang_v1.products_by_categories'))
            {!! Form::select('categories[]', $categories, $user_categories, 
                ['class' => 'form-control select2', 'multiple', 'id' => 'categories_select']) !!}
        </div>
    </div>

    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('brand', __( 'brand.brands' ) . ':*') !!} 
            @show_tooltip(__('lang_v1.products_by_brands'))
            {!! Form::select('brands[]', $brands, $user_brands, 
                ['class' => 'form-control select2', 'multiple', 'id' => 'brands_select']) !!}
        </div>
    </div>
    @endcomponent
        </div>
    ...
    @component('components.widget', ['title' => __('lang_v1.show_accounts_permissions')])
      ...
      <div class="col-md-6">
          <div class="form-group">
              ...
              {!! Form::select('accounts[]', $accounts, $user_accounts, [
      ...
      <div class="col-md-6">
          <div class="form-group">
              ...
              {!! Form::select('defult_account', [null => 'لا أحد'] + $accounts->toArray(), $user_defult_account, [
                  'class' => 'form-control select2', 
