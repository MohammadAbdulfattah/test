...
<input type="hidden" id="amount_rounding_method" value="{{$pos_settings['amount_rounding_method'] ?? ''}}">
 @php
    $enabled_sale_modules = (array)(!empty(session('business.enabled_sale_modules')) ? session('business.enabled_sale_modules') : []);
    @endphp
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			@component('components.widget', ['class' => 'box-solid'])
				...
				<div class="col-md-3 @if(!in_array('enable_sale_period', $enabled_sale_modules)) hide @endif">
		          <div class="form-group">
				...
				<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif @if(!in_array('enable_sale_date', $enabled_sale_modules)) hide @endif @if(!auth()->user()->can('date.access')) hide @endif">
					<div class="form-group">
				...
				@endif
				@if($sale_type != 'sales_order')
					<div class="col-sm-3 @if(!in_array('enable_invoice_design', $enabled_sale_modules)) hide @endif">
						<div class="form-group">
				...
				@endif
					...
					<div class="col-sm-3 @if(!in_array('enable_invoice_number', $enabled_sale_modules)) hide @endif">
						<div class="form-group">
		        ...
		        @endif
		        <div class="col-sm-3 @if(!in_array('enable_document_attachment', $enabled_sale_modules)) hide @endif">
	                <div class="form-group">
			...
			@endcomponent
				...
				@component('components.widget', ['class' => 'box-solid'])
					<div class="col-md-4  @if($sale_type == 'sales_order') hide @endif @if(!in_array('enable_discount', $enabled_sale_modules)) hide @endif">
						<div class="form-group">
					...
					<div class="col-md-4 @if($sale_type == 'sales_order') hide @endif @if(!in_array('enable_discount', $enabled_sale_modules)) hide @endif"><br>
					...
					<div class="clearfix"></div>
					<div class="col-md-4  @if($sale_type == 'sales_order') hide @endif @if(!in_array('enable_tax', $enabled_sale_modules)) hide @endif">
						<div class="form-group">
					...
					<div class="col-md-4 col-md-offset-4  @if($sale_type == 'sales_order') hide @endif @if(!in_array('enable_tax', $enabled_sale_modules)) hide @endif">
						<b>@lang( 'sale.order_tax' ):</b>(+) 
						<span class="display_currency" id="order_tax">0</span>
					</div>				
					
					<div class="col-md-12 @if(!in_array('enable_sale_note', $enabled_sale_modules)) hide @endif">
						<div class="form-group">
				...
				@component('components.widget', ['class' => 'box-solid'] )
				<div class="col-md-4 @if(!in_array('enable_shipping', $enabled_sale_modules)) hide @endif">
					<div class="form-group">
				...
				<div class="clearfix"></div>
				<div class="col-md-12 text-center @if(!in_array('enable_shipping', $enabled_sale_modules)) hide @endif">
				...
				<div class="col-md-8 col-md-offset-4 @if(!in_array('enable_shipping', $enabled_sale_modules)) hide @endif" id="additional_expenses_div" style="display: none;">
				...
				<div class="col-md-4 col-md-offset-8 @if(!in_array('enable_shipping', $enabled_sale_modules)) hide @endif">
