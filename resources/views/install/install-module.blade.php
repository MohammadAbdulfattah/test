              ...
              <form class="form" id="details_form" method="post" 
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @if($intruction_type == 'uf')
                                <p class="help-block"><a href="https://root-iq.dev/docs/ /license-key/#Getting-License-Details-for-products-purchased-from-ROOT CO.com" target="_blank">Where is my License Key?</a></p>
                            @endif
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @if($intruction_type == 'uf')
                                <p class="help-block"><a href="https://root-iq.dev/docs/ /user-name/#Steps-to-get-your-username-for-all-products-purchased-from-ROOT CO." target="_blank" class="text-success">Where is my Username?</a></p>
                            @endif
