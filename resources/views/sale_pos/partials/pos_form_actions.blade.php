        ...
        <div
            ...
            <div class="md:!tw-w-none !tw-flex md:!tw-hidden !tw-flex-row !tw-items-center !tw-gap-3">
                <div class="tw-pos-total tw-flex tw-items-center tw-gap-3">
                    ...
                    <input type="hidden" name="applied_smart_root_discount_ids" id="applied_smart_root_discount_ids" value="">
...
@endif
<script>
    window.LANG_TEMPLATE = "<?php echo __('messages.template'); ?>";
    const __messages = {
        discounts_type_one: "<?php echo __('messages.discounts_type_one'); ?>"
    };
    const __messages2 = {
        discounts_type_two: "<?php echo __('messages.discounts_type_two'); ?>"
    };
    const __messages3 = {
        discounts_type_three: "<?php echo __('messages.discounts_type_three'); ?>"
    };
</script>
