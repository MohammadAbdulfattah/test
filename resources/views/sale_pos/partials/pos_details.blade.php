					...
					<tr>
						<td>
							...
							<div class="col-sm-3 col-xs-12 d-inline-table">
								...
								<input type="hidden" name="applied_discount_ids" id="applied_discount_ids" value="[]">
								<input type="hidden" name="applied_discounts_type1_ids" id="applied_smart_root_discount_ids" value="[]">								<span id="total_payable" class="text-success lead text-bold">0</span>
								@if(empty($edit))
