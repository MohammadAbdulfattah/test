...
<section class="content">
    ...
    @component('components.widget', ['class' => 'box-primary'])
          ...
          <div class="col-md-9">
              ...
              <div class="col-md-12">
               ...
               <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'date.access', in_array('date.access', $role_permissions), 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'role.date.access' ) }}
                  </label>
                </div>
              </div> 
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'payment_date.access', in_array('payment_date.access', $role_permissions), 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'role.payment_date.access' ) }}
                  </label>
                </div>
              </div>
          </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                   ...
                   <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        {!! Form::checkbox('permissions[]', 'pay_for_contact', in_array('pay_for_contact', $role_permissions), 
                        [ 'class' => 'input-icheck']); !!} {{ __( 'role.pay_for_contact_from_pos' ) }}
                      </label>
                    </div>
                </div>
                  <div class="col-md-12">
        ...
        <hr>
                 <div class="row check_group">
        <div class="col-md-1">
          <h4>@lang( 'lang_v1.root_smart_discounts' ) @show_tooltip(__('lang_v1.root_smart_discounts'))</h4>
        </div>
        <div class="col-md-2">
            <div class="checkbox">
              <label>
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'smart_root_discount.access', in_array('smart_root_discount.access', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.root_smart_discounts' ) }}
              </label>
            </div>
          </div>
            ...
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'smart_root_discount.create', in_array('smart_root_discount.create', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.smart_root_discount_create' ) }}
              </label>
            </div>
          </div>
            ...
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'smart_root_discount.destroy', in_array('smart_root_discount.destroy', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.smart_root_discount_destroy' ) }}
              </label>
            </div>
          </div>
        ...
        <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'smart_root_discount.edit', in_array('smart_root_discount.edit', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.smart_root_discount_edit' ) }}
              </label>
            </div>
          </div>
           ...
           <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'show_smart_root_discounts_user', in_array('show_smart_root_discounts_user', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.show_smart_root_discounts_user' ) }}
              </label>
            </div>
          </div>
        ...
        <div class="col-md-9">
          ...
          @if(in_array('drivers', $enabled_modules))
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sell.assign_to_drivers', in_array('sell.assign_to_drivers', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.assign_to_driver' ) }}
                </label>
              </div>
            </div>
          @endif
        ...
        @endif
          ...
          <div class="col-md-12">
           ...
           <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'user_contacts_due_report.access', in_array('user_contacts_due_report.access', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'report.user_contacts_due_report_view' ) }}
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
           ...
           <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'dashboard.statistics', true, 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.dashboard.statistics' ) }}
              </label>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'dashboard.charts', true, 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.dashboard.charts' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'dashboard.quick', true, 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.dashboard.quick' ) }}
              </label>
            </div>
          </div>
        </div>
