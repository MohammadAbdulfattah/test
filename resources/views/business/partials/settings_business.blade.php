<div class="pos-tab-content active">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('allowed_distance', __('lang_v1.allowed_distance') . ':') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fas fa-map-marker-alt"></i>
                    </span>
                    {!! Form::number('allowed_distance', @num_format( $business->allowed_distance), [
                        'class' => 'form-control', 
                        'step' => '0.01',
                        'min' => '0', 
                        'placeholder' => 'البعد المسموح ب المتر'
                    ]) !!}
                </div>
                {{-- <p class="help-block">المسافة المسموحة بالكيلومترات (مثال: 0.2 = 200 متر)</p> --}}
            </div>
        </div>
        @endif
