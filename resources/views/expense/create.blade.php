...
<section class="content">\
	...
	<div class="box box-solid">
		<div class="box-body">
			<div class="row">
				...
				@endif
				<div class="col-sm-4 @if(!in_array('enable_user_location', $enabled_expenses_modules)) hide @endif">
				...
				<div class="col-sm-4 @if(!in_array('enable_categories', $enabled_expenses_modules)) hide @endif">
					<div class="form-group">
				...
				<div class="col-md-4 @if(!in_array('enable_categories', $enabled_expenses_modules)) hide @endif">
					<div class="form-group">
				...
				<div class="col-sm-4 @if(!in_array('enable_reference_number', $enabled_expenses_modules)) hide @endif">
					<div class="form-group">
				...
				<div class="col-sm-4 @if(!in_array('enable_expense_date', $enabled_expenses_modules)) hide @endif  @if(!auth()->user()->can('date.access')) hide @endif">
					<div class="form-group">
				...
				<div class="col-sm-4 @if(!in_array('enable_expense_for', $enabled_expenses_modules)) hide @endif">
					<div class="form-group">
				...
				<div class="clearfix"></div>
				<div class="col-sm-4 @if(!in_array('enable_expenses_for', $enabled_expenses_modules)) hide @endif">
                    <div class="form-group">
				...
				<div class="col-md-4 @if(!in_array('enable_tax', $enabled_expenses_modules)) hide @endif">
			    	<div class="form-group">
				...
				<div class="clearfix"></div>
				<div class="col-sm-4 @if(!in_array('enable_expense_note', $enabled_expenses_modules)) hide @endif">
					<div class="form-group">
	...
	@if (in_array('enable_payment', $enabled_expenses_modules))
