...
<section class="content">
 @php
    $enabled_purchases_modules = (array)(!empty(session('business.enabled_purchases_modules')) ? session('business.enabled_purchases_modules') : []);
@endphp
	...
	@component('components.widget', ['class' => 'box-primary'])
		<div class="row">
			...
			<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif @if(!in_array('enable_reference_number', $enabled_purchases_modules)) hide @endif">
				<div class="form-group">
				...
				<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif @if(!in_array('enable_purchase_note', $enabled_purchases_modules)) hide @endif   @if(!auth()->user()->can('date.access')) hide @endif">
					<div class="form-group">
			...
			<div class="col-md-3 @if(!in_array('enable_sale_period', $enabled_purchases_modules)) hide @endif">
		          <div class="form-group">
			...
			<div class="col-sm-3 @if(!in_array('enable_document_attachment', $enabled_purchases_modules)) hide @endif">
                <div class="form-group">
	...
	@endcomponent
		...
		@component('components.widget', ['class' => 'box-primary'])
			<div class="row">
				<div class="col-sm-12">
				<table class="table">
					<tr class="@if(!in_array('enable_discount', $enabled_purchases_modules)) hide @endif">
						<td class="col-md-3 ">
							<div class="form-group">
					...
					<tr class="@if(!in_array('enable_tax', $enabled_purchases_modules)) hide @endif"class="@if(!in_array('enable_tax', $enabled_purchases_modules)) hide @endif">
						<td >
							<div class="form-group">
					...
					<tr class="@if(!in_array('enable_purchase_note', $enabled_purchases_modules)) hide @endif">
						<td colspan="4">
							<div class="form-group">
		...
		@component('components.widget', ['class' => 'box-primary'])
		<div class="row @if(!in_array('enable_shipping', $enabled_purchases_modules)) hide @endif">
			<div class="col-md-4">
				<div class="form-group">
