    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row payment_row">
              @php
              if(count($selected_locations) >1){
                $selected_locations = collect($selected_locations)->map(fn($id) => (int)$id)->toArray();
              }
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          <span class="input-group-addon">
                            ...
                            {!! Form::select('business_locations[]', $business_locations, $selected_locations, [
                                'class' => 'form-control select2',
            ...
            @endif
                ...
                <div class="col-md-4 @if (!auth()->user()->can('payment_date.access')) hide @endif">
                    <div class="form-group">
