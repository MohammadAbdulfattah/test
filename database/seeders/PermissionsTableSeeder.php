...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            ['name' => 'smart_root_discount.access'],
            ['name' => 'smart_root_discount.create'],
            ['name' => 'smart_root_discount.destroy'],
            ['name' => 'smart_root_discount.edit'],
            ['name' => 'show_smart_root_discounts_user'],
            ...
            ['name' => 'payment_date.access'],
            ['name' => 'date.access'],

            ['name' => 'user_contacts_due_report.access'],

            ['name' => 'pay_for_contact'],
